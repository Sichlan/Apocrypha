...
[Migration("20220713162442_add_fallbacks_to_alphabet")]
partial class add_fallbacks_to_alphabet
{
...
#pragma warning disable 612, 618
        ...
        modelBuilder.Entity("Apocrypha.CommonObject.Models.FeatOption", b =>
        {
            b.HasOne("Apocrypha.CommonObject.Models.Race", null)
        ...
        modelBuilder.Entity("Apocrypha.CommonObject.Models.Race", b =>
        {
            ...
            b.HasOne("Apocrypha.CommonObject.Models.CreatureSizeCategory", "Size")
                .WithMany("Races")
                .HasForeignKey("SizeId");

            b.HasOne("Apocrypha.CommonObject.Models.CreatureSubType", "SubType")
                .WithMany("Races")
                .HasForeignKey("SubTypeId");

            b.HasOne("Apocrypha.CommonObject.Models.CreatureType", "Type")
                .WithMany("Races")
