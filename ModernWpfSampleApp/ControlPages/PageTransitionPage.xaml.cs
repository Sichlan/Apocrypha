...
namespace ModernWpf.SampleApp.ControlPages
{
    public sealed partial class PageTransitionPage : Page
    {
        ...
        public PageTransitionPage()
        {
            ...
            ContentFrame.Navigate(typeof(SamplesCommon.SamplePages.SamplePage1));
        }

        private void ForwardButton1_Click(object sender, RoutedEventArgs e)
        {
            var pageToNavigateTo = ContentFrame.BackStackDepth % 2 == 1
                ? typeof(SamplesCommon.SamplePages.SamplePage1)
                : typeof(SamplesCommon.SamplePages.SamplePage2);
