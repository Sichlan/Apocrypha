...
namespace ModernWpfSampleApp.ControlPages
{
    public partial class ItemsRepeaterPage
    {
        ...
        private void RadioBtn_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (layoutKey.Equals(nameof(this
                    .VerticalStackLayout))) // we used x:Name in the resources which both acts as the x:Key value and creates a member field by the same name
            {
                itemTemplateKey = "HorizontalBarTemplate";
